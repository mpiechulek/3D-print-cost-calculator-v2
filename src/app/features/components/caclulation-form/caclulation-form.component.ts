...
import { UserFormSettings } from 'app/shared/models/storage-data.model';
...
export class CaclulationFormComponent {
  readonly userFormSetting = input<UserFormSettings>();
   currenUserFormSetting = output<UserFormSettings>();
